...
class Lobby extends Phaser.State {
	...
	create(){
		...
		this.lobbyTable.addNewRow([25, 25, 25, 25], [this.text1, 'Text 2', 'Text 3', this.text4]);
		this.lobbyTable.addNewRow([25, 25, 25, 25], ['Text 1', 'Text 2', 'Text 3', 'Text 4']);
		this.lobbyTable.addNewRow([25, 25, 25, 25], ['Text 5', 6, 'Text 7', 'Text 8']);
		this.lobbyTable.addNewRow([25, 25, 25, 25], [this.header1, 'Text 10', this.text3, 'Text 12']);
