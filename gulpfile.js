...
/*
Copy phaser-kinetic-scrolling-plugin.min.js plugin file to build.
*/
function copyKinetic() {

    var srcList = ['phaser-kinetic-scrolling-plugin.min.js'];
    
    srcList = srcList.map(function(file) {
        return './node_modules/phaser-kinetic-scrolling-plugin/dist/' + file;
    });
...
gulp.task('copyKinetic', ['copyPhaser'], copyKinetic);
gulp.task('build', ['copyKinetic'], build);
